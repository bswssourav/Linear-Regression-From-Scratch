...
def SquareCostRunner():
    ...
    print("For square cost function For polynomial n=1 estimated W : m {}, b {},squareError {}".format(m_1, b_1, er_1))
    test_er1 = compute_SquareError_polynomial_1(b_1, m_1, x_test, y_test)
    print("For square cost function test data for polynomial n==1 is ==", test_er1)

    # polynomial n=2 ------------------
    [b_2, m_2_1, m_2_2, er_2] = gradient_descent_polynomial_x_2(x, y, iteration, learning_rate)
    print("For square cost function For polynomial n=2 estimated W : m_2_1 {}, m_2_2 {} , b {},squareError {}".format(m_2_1, m_2_2, b_2, er_2))
    test_er2 = compute_SquareError_polynomial_2(b_2, m_2_1, m_2_2, x_test, y_test)
    print("For square cost function test error on test data for polynomial n==2 is ==", test_er2)

    # polynomial n=3 ------------------
    [b_3, m_3_1, m_3_2, m_3_3, er_3] = gradient_descent_polynomial_x_3(x, y, iteration, learning_rate)
    print(
        "For square cost function For polynomial n=3 estimated W : m_3_1 {}, m_3_2 {} ,m_3_3{}, b {},squareError {}".format(m_3_1, m_3_2, m_3_3,
                                                                                                   b_3, er_3))
    test_er3 = compute_SquareError_polynomial_3(b_3, m_3_1, m_3_2, m_3_3, x_test, y_test)
    print("For square cost function test error on test data for polynomial n==3 is ==", test_er3)

    # polynomial n=4 ------------------
    [b_4, m_4_1, m_4_2, m_4_3, m_4_4, er_4] = gradient_descent_polynomial_x_4(x, y, iteration, learning_rate)
    print("For square cost function For polynomial n=4 estimated W : m_4_1 {}, m_4_2 {} ,m_4_3 {},m_4_4 {} , b_4 {},squareError {}".format(m_4_1,
                                                                                                                  m_4_2,
                                                                                                                  m_4_3,
                                                                                                                  m_4_4,
                                                                                                                  b_4,
    ...
    print("For square cost function test error on test data for polynomial n==4 is ==", test_er4)

    # polynomial n=5 ------------------
    [b_5, m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, er_5] = gradient_descent_polynomial_x_5(x, y, iteration, learning_rate)
    print(
        "For square cost function For polynomial n=5 estimated W : m_5_1 {}, m_5_2 {} ,m_5_3 {},m_5_4 {}, m_5_5 {} , b_5 {},squareError {}".format(
    ...
    print("For square cost function test error on test data for polynomial n==5 is ==", test_er5)

    # polynomial n=6 ------------------
    [b_6, m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, er_6] = gradient_descent_polynomial_x_6(x, y, iteration,
                                                                                            learning_rate)
    print(
        "For square cost function For polynomial n=6 estimated W : m_6_1 {}, m_6_2 {} ,m_6_3 {},m_6_4 {}, m_6_5 {} , m_6_6 {}, b_6 {},squareError {}".format(
    ...
    print("For square cost function test error on test data for polynomial n==6 is ==", test_er6)

    # polynomial n=7 ------------------
    [b_7, m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, er_7] = gradient_descent_polynomial_x_7(x, y, iteration,
                                                                                                   learning_rate)
    print(
        "For square cost function For polynomial n=7 estimated W : m_7_1 {}, m_7_2 {} ,m_7_3 {},m_7_4 {}, m_7_5 {} , m_7_6 {},m_7_7 {}, b_7 {},squareError {}".format(
    ...
    print("For square cost function test error on test data for polynomial n==7 is ==", test_er7)
    ...
    [b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, er_8] = gradient_descent_polynomial_x_8(x, y,
                                                                                                          ...
                                                                                                          learning_rate)
    print(
        "For square cost function For polynomial n=8 estimated W : m_8_1 {}, m_8_2 {} ,m_8_3 {},m_8_4 {}, m_8_5 {} , m_8_6 {},m_8_7 {},m_8_8 {},b_8 {},squareError {}".format(
    ...
    test_er8 = compute_SquareError_polynomial_8(b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, x_test,
                                                y_test)
    print("For square cost function test error on test data for polynomial n==8 is ==", test_er8)
    ...
    [b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9, er_9] = gradient_descent_polynomial_x_9(x, y,
                                                                                                                 ...
                                                                                                                 learning_rate)
    print(
        "For square cost function For polynomial n=9 estimated W : m_9_1 {}, m_9_2 {} ,m_9_3 {},m_9_4 {}, m_9_5 {} , m_9_6 {},m_9_7 {},m_9_8 {},m_9_9 {},b_9 {},squareError {}".format(
    ...
    test_er9 = compute_SquareError_polynomial_9(b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9,
                                                x_test, y_test)
    print("For square cost function test error on test data for polynomial n==9 is ==", test_er9)
    ...
    plt.title("Separate train Square error plot on square cost function")
    ...
    plt.title("Separate test Square error plot on square cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, test_error, color='green')
    # plt.plot(x2,test_error, color='green')
    plt.show()
    ...
    plt.title("Both Square error plot on square cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
...
def absCostRunner():
    ...
    print("For abs cost function For polynomial n=1 estimated W : m {}, b {},absError {}".format(m_1, b_1, er_1))
    ...
    print("For abs cost function For polynomial n=2 estimated W : m_2_1 {}, m_2_2 {} , b {},absError {}".format(m_2_1, m_2_2, b_2, er_2))
    test_er2 = abs_compute_SquareError_polynomial_2(b_2, m_2_1, m_2_2, x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==2 is ==", test_er2)

    # polynomial n=3 ------------------
    [b_3, m_3_1, m_3_2, m_3_3, er_3] = abs_gradient_descent_polynomial_x_3(x, y, iteration, learning_rate)
    print(
        "For abs cost function For polynomial n=3 estimated W : m_3_1 {}, m_3_2 {} ,m_3_3{}, b {},absError {}".format(m_3_1, m_3_2, m_3_3,
                                                                                                   b_3, er_3))
    test_er3 = abs_compute_SquareError_polynomial_3(b_3, m_3_1, m_3_2, m_3_3, x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==3 is ==", test_er3)

    # polynomial n=4 ------------------
    [b_4, m_4_1, m_4_2, m_4_3, m_4_4, er_4] = abs_gradient_descent_polynomial_x_4(x, y, iteration, learning_rate)
    print("For abs cost function For polynomial n=4 estimated W : m_4_1 {}, m_4_2 {} ,m_4_3 {},m_4_4 {} , b_4 {},absError {}".format(m_4_1,
                                                                                                                  m_4_2,
                                                                                                                  m_4_3,
                                                                                                                  m_4_4,
                                                                                                                  b_4,
    ...
    print("For abs cost function test error on test data for polynomial n==4 is ==", test_er4)

    # polynomial n=5 ------------------
    [b_5, m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, er_5] = abs_gradient_descent_polynomial_x_5(x, y, iteration, learning_rate)
    print(
        "For abs cost function For polynomial n=5 estimated W : m_5_1 {}, m_5_2 {} ,m_5_3 {},m_5_4 {}, m_5_5 {} , b_5 {},absError {}".format(
            m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, b_5, er_5))
    test_er5 = abs_compute_SquareError_polynomial_5(b_5, m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==5 is ==", test_er5)

    # polynomial n=6 ------------------
    [b_6, m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, er_6] = abs_gradient_descent_polynomial_x_6(x, y, iteration,
                                                                                            learning_rate)
    print(
        "For abs cost function For polynomial n=6 estimated W : m_6_1 {}, m_6_2 {} ,m_6_3 {},m_6_4 {}, m_6_5 {} , m_6_6 {}, b_6 {},absError {}".format(
            m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, b_6, er_6))
    test_er6 = abs_compute_SquareError_polynomial_6(b_6, m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==6 is ==", test_er6)

    # polynomial n=7 ------------------
    [b_7, m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, er_7] = abs_gradient_descent_polynomial_x_7(x, y, iteration,
                                                                                                   learning_rate)
    print(
        "For abs cost function For polynomial n=7 estimated W : m_7_1 {}, m_7_2 {} ,m_7_3 {},m_7_4 {}, m_7_5 {} , m_7_6 {},m_7_7 {}, b_7 {},absError {}".format(
            m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, b_7, er_7))
    test_er7 = abs_compute_SquareError_polynomial_7(b_7, m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==7 is ==", test_er7)
    ...
    [b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, er_8] = abs_gradient_descent_polynomial_x_8(x, y,
                                                                                                          ...
                                                                                                          learning_rate)
    print(
        "For abs cost function For polynomial n=8 estimated W : m_8_1 {}, m_8_2 {} ,m_8_3 {},m_8_4 {}, m_8_5 {} , m_8_6 {},m_8_7 {},m_8_8 {},b_8 {},absError {}".format(
            m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, b_8, er_8))
    test_er8 = abs_compute_SquareError_polynomial_8(b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, x_test,
                                                y_test)
    print("For abs cost function test error on test data for polynomial n==8 is ==", test_er8)
    ...
    [b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9, er_9] = abs_gradient_descent_polynomial_x_9(x, y,
                                                                                                                 ...
                                                                                                                 learning_rate)
    print(
        "For abs cost function For polynomial n=9 estimated W : m_9_1 {}, m_9_2 {} ,m_9_3 {},m_9_4 {}, m_9_5 {} , m_9_6 {},m_9_7 {},m_9_8 {},m_9_9 {},b_9 {},absError {}".format(
            m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9, b_9, er_9))
    test_er9 = abs_compute_SquareError_polynomial_9(b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9,
                                                x_test, y_test)
    print("For abs cost function test error on test data for polynomial n==9 is ==", test_er9)

    train_error = [er_1, er_2, er_3, er_4, er_5, er_6, er_7, er_8, er_9]
    test_error = [test_er1, test_er2, test_er3, test_er4, test_er5, test_er6, test_er7, test_er8, test_er9]
    print("For abs cost function train error==", train_error)
    x2 = [1, 2, 3, 4, 5, 6, 7, 8, 9]

    plt.xlabel('polynomial of x')
    plt.ylabel('Train_square_error ')
    plt.title("Separate train Square error plot on abs cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, train_error, color='blue')
    # plt.plot(x2,test_error, color='green')
    plt.show()
    ...
    plt.xlabel('polynomial of x')
    plt.ylabel('Test_square_error  ')
    plt.title("Separate test Square error plot on abs cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, test_error, color='green')
    # plt.plot(x2,test_error, color='green')
    plt.show()
    ...
    plt.xlabel('polynomial of X')
    plt.ylabel('train_square_error and test_square_error ')
    plt.title("Both Square error plot on abs cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, train_error, color='blue', marker='*', label='Train_error curve')
    plt.plot(x2, test_error, color='green', marker='.', label='Test_error curve')
    plt.legend()
...
def fourthPowerCostRunner():
    ...
    print("For fourth cost function For polynomial n=1 estimated W : m {}, b {},absError {}".format(m_1, b_1, er_1))
    test_er1 = fourth_compute_SquareError_polynomial_1(b_1, m_1, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==1 is ==", test_er1)

    # polynomial n=2 ------------------
    [b_2, m_2_1, m_2_2, er_2] = fourth_gradient_descent_polynomial_x_2(x, y, iteration, learning_rate)
    print("For fourth cost function For polynomial n=2 estimated W : m_2_1 {}, m_2_2 {} , b {},absError {}".format(m_2_1, m_2_2, b_2, er_2))
    test_er2 = fourth_compute_SquareError_polynomial_2(b_2, m_2_1, m_2_2, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==2 is ==", test_er2)

    # polynomial n=3 ------------------
    [b_3, m_3_1, m_3_2, m_3_3, er_3] = fourth_gradient_descent_polynomial_x_3(x, y, iteration, learning_rate)
    print(
        "For fourth cost function For polynomial n=3 estimated W : m_3_1 {}, m_3_2 {} ,m_3_3{}, b {},absError {}".format(m_3_1, m_3_2, m_3_3,
                                                                                                   b_3, er_3))
    test_er3 = fourth_compute_SquareError_polynomial_3(b_3, m_3_1, m_3_2, m_3_3, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==3 is ==", test_er3)

    # polynomial n=4 ------------------
    [b_4, m_4_1, m_4_2, m_4_3, m_4_4, er_4] = fourth_gradient_descent_polynomial_x_4(x, y, iteration, learning_rate)
    print("For fourth cost function For polynomial n=4 estimated W : m_4_1 {}, m_4_2 {} ,m_4_3 {},m_4_4 {} , b_4 {},absError {}".format(m_4_1,
                                                                                                                  m_4_2,
                                                                                                                  m_4_3,
                                                                                                                  m_4_4,
                                                                                                                  b_4,
    ...
    print("For fourth cost function test error on test data for polynomial n==4 is ==", test_er4)

    # polynomial n=5 ------------------
    [b_5, m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, er_5] = fourth_gradient_descent_polynomial_x_5(x, y, iteration, learning_rate)
    print(
        "For fourth cost function For polynomial n=5 estimated W : m_5_1 {}, m_5_2 {} ,m_5_3 {},m_5_4 {}, m_5_5 {} , b_5 {},absError {}".format(
            m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, b_5, er_5))
    test_er5 = fourth_compute_SquareError_polynomial_5(b_5, m_5_1, m_5_2, m_5_3, m_5_4, m_5_5, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==5 is ==", test_er5)

    # polynomial n=6 ------------------
    [b_6, m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, er_6] = fourth_gradient_descent_polynomial_x_6(x, y, iteration,
                                                                                            learning_rate)
    print(
        "For fourth cost function For polynomial n=6 estimated W : m_6_1 {}, m_6_2 {} ,m_6_3 {},m_6_4 {}, m_6_5 {} , m_6_6 {}, b_6 {},absError {}".format(
            m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, b_6, er_6))
    test_er6 = fourth_compute_SquareError_polynomial_6(b_6, m_6_1, m_6_2, m_6_3, m_6_4, m_6_5, m_6_6, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==6 is ==", test_er6)

    # polynomial n=7 ------------------
    [b_7, m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, er_7] = fourth_gradient_descent_polynomial_x_7(x, y, iteration,
                                                                                                   learning_rate)
    print(
        "For fourth cost function For polynomial n=7 estimated W : m_7_1 {}, m_7_2 {} ,m_7_3 {},m_7_4 {}, m_7_5 {} , m_7_6 {},m_7_7 {}, b_7 {},absError {}".format(
            m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, b_7, er_7))
    test_er7 = fourth_compute_SquareError_polynomial_7(b_7, m_7_1, m_7_2, m_7_3, m_7_4, m_7_5, m_7_6, m_7_7, x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==7 is ==", test_er7)
    ...
    [b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, er_8] = fourth_gradient_descent_polynomial_x_8(x, y,
                                                                                                          ...
                                                                                                          learning_rate)
    print(
        "For fourth cost function For polynomial n=8 estimated W : m_8_1 {}, m_8_2 {} ,m_8_3 {},m_8_4 {}, m_8_5 {} , m_8_6 {},m_8_7 {},m_8_8 {},b_8 {},absError {}".format(
            m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, b_8, er_8))
    test_er8 = fourth_compute_SquareError_polynomial_8(b_8, m_8_1, m_8_2, m_8_3, m_8_4, m_8_5, m_8_6, m_8_7, m_8_8, x_test,
                                                y_test)
    print("For fourth cost function test error on test data for polynomial n==8 is ==", test_er8)
    ...
    [b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9, er_9] = fourth_gradient_descent_polynomial_x_9(x, y,
                                                                                                                 ...
                                                                                                                 learning_rate)
    print(
        "For fourth cost function For polynomial n=9 estimated W : m_9_1 {}, m_9_2 {} ,m_9_3 {},m_9_4 {}, m_9_5 {} , m_9_6 {},m_9_7 {},m_9_8 {},m_9_9 {},b_9 {},absError {}".format(
            m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9, b_9, er_9))
    test_er9 = fourth_compute_SquareError_polynomial_9(b_9, m_9_1, m_9_2, m_9_3, m_9_4, m_9_5, m_9_6, m_9_7, m_9_8, m_9_9,
                                                x_test, y_test)
    print("For fourth cost function test error on test data for polynomial n==9 is ==", test_er9)
    ...
    plt.xlabel('polynomial of x')
    plt.ylabel('Train_square_error ')
    plt.title("Separate train Square error plot on fourth power cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, train_error, color='blue')
    # plt.plot(x2,test_error, color='green')
    plt.show()
    ...
    plt.xlabel('polynomial of x')
    plt.ylabel('Test_square_error  ')
    plt.title("Separate test Square error plot on fourth power cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, test_error, color='green')
    # plt.plot(x2,test_error, color='green')
    plt.show()
    ...
    plt.xlabel('polynomial of X')
    plt.ylabel('train_square_error and test_square_error ')
    plt.title("Both Square error plot on fourth power cost function")
    # plt.scatter(df.x,df.y, color='red', marker= '*')
    plt.plot(x2, train_error, color='blue', marker='*', label='Train_error curve')
    plt.plot(x2, test_error, color='green', marker='.', label='Test_error curve')
    plt.legend()
...
strain_error=[stest_er1, stest_er2, stest_er3, stest_er4, stest_er5, stest_er6, stest_er7, stest_er8, stest_er9]
atest_error=[atest_er1, atest_er2, atest_er3, atest_er4, atest_er5, atest_er6, atest_er7, atest_er8, atest_er9]
ftrain_error=[ftest_er1, ftest_er2, ftest_er3, ftest_er4, ftest_er5, ftest_er6, ftest_er7, ftest_er8, ftest_er9]
plt.xlabel('polynomial of X')
plt.ylabel(' test_square_error ')
plt.title("Test square error of different cost function")
plt.plot(x, strain_error, color='blue', marker='*', label='Square Cost fn error')
